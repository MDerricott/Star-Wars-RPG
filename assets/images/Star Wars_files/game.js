...
var hansSolo = {
    ...
    showOff: function () {
        ...
        if (!hansSolo.playerOne && !hansSolo.defender) {
            $(".hsshow-off").text(hansSolo.healthPoints + " HP");
        } 
        else if (hansSolo.playerOne) {
            $(".hsshow-off").text(" Your Player!");
        } 
        else if(hansSolo.defender){
            $(".hsshow-off").text(" The Defender!");
        }
     }
}
...
var klyoRen = {
    ...
    showOff: function () {
        ...
        if (!klyoRen.playerOne && !klyoRen.defender) {
            $(".krshow-off").text(klyoRen.healthPoints + " HP");
        } 
        else if (klyoRen.playerOne) {
            $(".krshow-off").text(" Your Player!");
        } 
        else if(klyoRen.defender){
            $(".krshow-off").text(" The Defender!");
        }
     }
}
...
var lukeSkywalker = {
    ...
    showOff: function () {
        ...
        if (!lukeSkywalker.playerOne && !lukeSkywalker.defender) {
            $(".lsshow-off").text(lukeSkywalker.healthPoints + " HP");
        } 
        else if (lukeSkywalker.playerOne) {
            $(".lsshow-off").text(" Your Player!");
        } 
        else if(lukeSkywalker.defender){
            $(".lsshow-off").text(" The Defender!");
        }
     }
}
...
var princessLeia = {
    ...
    showOff: function () {
        ...
        if (!princessLeia.playerOne && !princessLeia.defender) {
            $(".plshow-off").text(princessLeia.healthPoints + " HP");
        } 
        else if (princessLeia.playerOne) {
            $(".plshow-off").text(" Your Player!");
        } 
        else if(princessLeia.defender){
            $(".plshow-off").text(" The Defender!");
        }
     }
}
